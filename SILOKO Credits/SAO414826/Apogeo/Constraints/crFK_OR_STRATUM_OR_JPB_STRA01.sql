...
--
-- Archivo       : crFK_OR_STRATUM_OR_JPB_STRA01.sql
...
PROMPT - Script  :  crFK_OR_STRATUM_OR_JPB_STRA01.sql
PROMPT - Author  :  Semillero 2018 1
PROMPT
PROMPT - Adding foreing key FK_OR_STRATUM_OR_JPB_STRA01 to table OR_STRATUM_BY_CITY

ALTER TABLE OR_STRATUM_BY_CITY ADD
    (
        CONSTRAINT FK_OR_STRATUM_OR_JPB_STRA01
