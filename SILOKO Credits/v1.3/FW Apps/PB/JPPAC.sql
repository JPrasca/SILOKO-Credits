...
BEGIN
    EXECUTE IMMEDIATE ''||
        'CREATE OR REPLACE FUNCTION fblB64Clob11052018182855870654'|| chr(10) ||
        '('|| chr(10) ||
...
/
BEGIN
    EXECUTE IMMEDIATE 'GRANT EXECUTE ON fblB64Clob11052018182855870654 TO SYSTEM_OBJ_PRIVS_ROLE';
END;
/
DECLARE
...
dbms_lob.append(clB64FileContent, 'UEsDBAoAAAAAAJyTq0wAAAAAAAAAAAAAAAAGABwASlBQQUMvVVQJAAM3J/ZaNyf2WnV4CwABBPUB
AAAE9AEAAFBLAwQUAAIACACck6tMaYULNBcCAABeBAAADAAcAEpQUEFDL2FwcC5qc1VUCQADNyf2
Wjcn9lp1eAsAAQT1AQAABPQBAAC9k81uEzEQgF8l8gkkK2oquGyFxOaHakv+6CZcoiryrifJgNd2
...
DRxk3vFn5QykizY3/pai/yqbox+kwJyFudYkRtPute6jLafxnHiGp4sfUEsDBBQAAgAIAJyTq0wa
vCu8WwEAAJgCAAAQABwASlBQQUMvaW5kZXguaHRtbFVUCQADNyf2Wjcn9lp1eAsAAQT1AQAABPQB
...
');
blFileContent := fblB64Clob11052018182855870654(clB64FileContent);
...
/
BEGIN
    EXECUTE IMMEDIATE 'DROP FUNCTION fblB64Clob11052018182855870654';
END;
/
